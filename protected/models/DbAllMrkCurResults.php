...
/**
 * This is the model class for table "all_mrk_cur_results".
 *
 * The followings are the available columns in table 'all_mrk_cur_results':
 ...
 *
 * @property DbCurrencies $currency
 */
class DbAllMrkCurResults extends ActiveRecordMarketData {
    /**
     * @return string the associated database table name
     */
    public function tableName () {
        return 'ALL_MRK_CUR_RESULTS';
    }
    ...
    public function relations () {
        return array(
            'currency' => array(self::BELONGS_TO, 'DbCurrencies', array('Asset_ID' => 'code')),
     ...
     * @return DbAllMrkCurResults the static model class
     */
