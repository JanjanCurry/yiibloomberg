...
/**
 * This is the model class for table "db_currencies".
 *
 * The followings are the available columns in table 'db_currency':
 * @property integer $id
 ...
 */
class DbCurrencies extends ActiveRecord {
    /**
     ...
     * @return DbCurrencies the static model class
     */
