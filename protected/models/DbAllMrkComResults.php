...
/**
 * This is the model class for table "all_mrk_com_results".
 *
 * The followings are the available columns in table 'all_mrk_com_results':
 ...
 *
 * @property DbCommodities $commodity
 */
class DbAllMrkComResults extends ActiveRecordMarketData {
    /**
     * @return string the associated database table name
     */
    public function tableName () {
        return 'ALL_MRK_COM_RESULTS';
    }
    ...
    public function relations () {
        return array(
            'commodity' => array(self::BELONGS_TO, 'DbCommodities', array('Asset_ID' => 'code')),
     ...
     * @return DbAllMrkComResults the static model class
     */
