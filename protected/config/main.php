<?php
Yii::setPathOfAlias('root', '/home/apicom/public_html/');
Yii::setPathOfAlias('website', 'http://api.completeintel.com/');

// This is the main Web application configuration. Any writable
// CWebApplication properties can be configured here.
return array(
    'basePath' => dirname(__FILE__) . DIRECTORY_SEPARATOR . '..',
    'name' => 'Complete Intelligence Technologies, Inc.',
    ...
    'components' => array(
        ...
        'db' => array(
            'connectionString' => 'mysql:host=localhost;dbname=apicom_live',
        ...
        'simplesamlphp' => array(
            ...
            'autoloadPath' => '/home/apicom/public_html/vendor/simplesamlphp/lib/_autoload.php',
    ...
    'params' => array(
        'name' => 'Complete Intelligence Technologies, Inc.',
        'address' => '8111 Ashlane Way, Suite 211, The Woodlands, TX 77382',
