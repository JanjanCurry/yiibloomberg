<?php
Yii::setPathOfAlias('root', '/home/bbgci/public_html/');
Yii::setPathOfAlias('website', 'https://bbg.completeintel.com/');
// Yii::setPathOfAlias('root', DIR_PATH);
// Yii::setPathOfAlias('website', WEBSITE);
...
return array(
    ...
    'components' => array(
        ...
        'db' => array(
            'connectionString' => 'mysql:host=localhost;dbname=yiibloomberg',
            'username' => 'root',
            'password' => '',
            'emulatePrepare' => true,
            'charset' => 'utf8',
