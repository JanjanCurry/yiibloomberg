...
<?php $form = $this->beginWidget('CActiveForm', array(
    ...
    <p>Enter your new password into the 2 fields below and then click save to create your password.</p>
...
<?php echo $form->errorSummary($login, '', null, array('class' => 'alert alert-danger text-left')); ?>
    ...
    <div class="form-group captcha-center">
        <?php $this->widget('application.extensions.yiiReCaptcha.ReCaptcha', array(
            'model' => $login,
