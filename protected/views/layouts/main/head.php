<head>
	...
	<?php 
        if(!empty($this->metaDesc)){
            echo '<meta name="description" content="'.$this->metaDesc.'" />';
        }
    ?>

    <link rel="shortcut icon" href="<?php echo Yii::app()->request->baseUrl; ?>/images/favicon/favicon.ico"/>
    ...
    <meta property="og:image" content="<?php echo Yii::app()->getBaseUrl(true) . '/images/ci-logo.png'; ?>"/>
    <meta property="og:image:secure_url" content="<?php echo Yii::app()->getBaseUrl(true) . '/images/ci-logo.png'; ?>" />
