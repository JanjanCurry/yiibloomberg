<?php class EquityController extends Controller {
    ...
    public function actionIndex ($id = null) {
        ...
        if (!empty($id)) {
            ...
            $equity = DbEquities::model()->find($criteria);
            if (!empty($equity)) {
                if($equity->access > 1){
                    $this->checkAccess('service-pro', 'equ');
                }
