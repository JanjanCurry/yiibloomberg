<?php class CommodityController extends Controller {
    ...
    public function actionIndex($id = null){
        ...
        if(!empty($id)){
            ...
            $commodity = DbCommodities::model()->find($criteria);
            if(!empty($commodity)){
                if($commodity->access > 1){
                    $this->checkAccess('service-pro', 'com');
                }
