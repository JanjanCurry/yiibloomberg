...
if (Yii::app()->user->checkToolAccess($this->getTool(),'favorites')) {
...
//                ));
        ...
        <div class="col-xs-2 text-right">
            <div class="btn-group" role="group">
                ...
                <?php /*<button type="button" class="btn btn-trans btn-sm" aria-label="Further Information" data-toggle="tooltip" title="<span class='fa fa-minus'></span> Historical<br><span class='fa fa-ellipsis-h'></span> Forecast"><span class="fa fa-info-circle"></span></button> */ ?>
                ...
                <ul class="dropdown-menu pull-right chart-btns">
                    <?php if($this->editable){ ?>
                        <?php if($this->showCompare){ ?>
                        <li><a class="dropdown-item chart-btn-update-id" href="#" data-toggle="modal" data-target="#chartMarketCompareModal"><span class="fa fa-pencil"></span> Compare Asset</a></li>
                        <?php } ?>
                        <li><a class="dropdown-item chart-btn-update-id chart-edit-btn" href="#" data-toggle="modal" data-target="#chartMarketModal"><span class="fa fa-pencil"></span> Edit Asset</a></li>
                    ...
                    if ($accessFavorites) {
                        echo '<li><a class="dropdown-item toggle-favorite" href="#" data-type="'.$this->market.'"><span class="fa fa-star"></span> ' . $favoriteAction . ' Favorite</a></li>';
                    } else {
...
<?php $this->render('chart/legend', ['forecast' => true]); ?>