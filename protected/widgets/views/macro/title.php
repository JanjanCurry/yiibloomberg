...
//                ));
            ...
            if(!empty($this->basePeriod)){
                echo '<small class="text-danger" style="position: absolute; top:22px;">'.$this->getListLabel('listPeriod',$this->basePeriod).' data not available.</small>';
            }
            ...
            <div class="btn-group" role="group">
                ...
                <ul class="dropdown-menu pull-right chart-btns">
                    <?php if($this->editable){ ?>
                        ...
                        <li><a class="dropdown-item chart-btn-update-id" href="#" data-toggle="modal" data-target="#chartCompareModal"><span class="fa fa-pencil"></span> Compare Macro</a></li>
                        <?php } ?>
                        <li><a class="dropdown-item chart-btn-update-id chart-edit-btn" href="#" data-toggle="modal" data-target="#chartMacroModal"><span class="fa fa-pencil"></span> Edit Macro</a></li>
                    ...
                    if ($accessFavorites) {
                        echo '<li><a class="dropdown-item toggle-favorite" href="#" data-type="macro"><span class="fa fa-star"></span> ' . $favoriteAction . ' Favorite</a></li>';
                    } else {
